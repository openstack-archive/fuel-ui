  ...
  return {
    ...
    'Check "Guest OS DNS Servers" extendable list'() {
      ...
      return this.remote
        .clickByCssSelector('.subtab-link-neutron_l3')
        .sleep(1000)
        .assertElementsExist(addFieldBtn, 2, 'Something wrong with "add field" btn')
        .clickByCssSelector(rmFieldBtn)
        .assertElementDisappears(rmFieldBtn, 200, '"remove field" btn exist(expected: should not)')
        .assertElementsExist(addFieldBtn, 1, 'Something wrong with "add field" btn')
        .clickByCssSelector(addFieldBtn)
        .clickByCssSelector(addFieldBtn)
        .clickByCssSelector(addFieldBtn)
        .clickByCssSelector(addFieldBtn)
        .assertElementDisappears(addFieldBtn, 200, '"add field" btn exist(expected: should not)')
        .assertElementsExist(rmFieldBtn, 5, '"remove field" btn does not exist')
        .clickByCssSelector(rmFieldBtn)
        .clickByCssSelector(rmFieldBtn)
        .clickByCssSelector(rmFieldBtn)
        .clickByCssSelector(rmFieldBtn)
        .assertElementDisappears(rmFieldBtn, 200, 'Something wrong with "remove field" btn')
        .assertElementsExist(addFieldBtn, 1, 'Something wrong with "add field" btn')
    ...
    'Check "Host OS DNS servers" extendable list'() {
      ...
      return this.remote
        ...
        .clickByCssSelector(addFieldBtn)
        .clickByCssSelector(addFieldBtn)
        .assertElementDisappears(addFieldBtn, 200, 'Something wrong with "add field" btn')
        .assertElementsExist(rmFieldBtn, 3, 'Something wrong with "remove field" btn')
        .clickByCssSelector(rmFieldBtn)
        .clickByCssSelector(rmFieldBtn)
        .assertElementDisappears(rmFieldBtn, 200, 'Something wrong with "remove field" btn')
        .assertElementsExist(addFieldBtn, 1, 'Something wrong with "add field" btn')
