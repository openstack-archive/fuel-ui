...
class NetworksLib {
  ...
  checkNetworkVerificationSegment() {
    ...
    var linkSelector = '.subtab-link-network_verification';
    ...
    return this.remote
      .clickByCssSelector(linkSelector)
      .assertElementExists('li.active ' + linkSelector, '"Connectivity Check" subtab is selected')
