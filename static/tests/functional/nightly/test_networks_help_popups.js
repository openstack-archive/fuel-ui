...
import 'tests/functional/pages/modal';
...
registerSuite(function() {
  ...
  return {
    ...
    'Check "Admin (PXE)" network help tooltip': function() {
      ...
      var textAdmin = 'For security reasons, isolate this network from the ' +
    ...
    'Check "Storage" network help tooltip': function() {
      ...
      var textStorage = 'This is an internal network, therefore, assign a private ' +
      'IP address range.';
      return this.remote
        .setFindTimeout(3000)
    ...
    'Check "Managment" network help tooltip': function() {
      ...
      var textManagment = 'This is an internal network, therefore, assign a private ' +
      'IP address range.';
      return this.remote
        .setFindTimeout(3000)
    ...
    'Check "Neutron L2 Configuration" help tooltip': function() {
      var self = this;
      var neutronlTwoPopoverContainer = '.form-neutron-l2 .popover-container';
      var neutronlTwoTooltip = neutronlTwoPopoverContainer + ' i.tooltip-icon';
      var textNeutron = 'One unique Tunnel ID is required for each tenant network.';
      return this.remote
        .clickByCssSelector('.subtab-link-neutron_l2')
        .setFindTimeout(3000)
        .findByCssSelector(neutronlTwoTooltip)
          .then(function(element) {
            return self.remote.moveMouseTo(element);
          })
          .end()
    ...
    'Check "Internal Network Parameters" help tooltip': function() {
      ...
      var textInternal = 'For security reasons, isolate this network from the Private ' +
      'and Public networks.';
      return this.remote
        .clickByCssSelector('.subtab-link-neutron_l3')
        .setFindTimeout(3000)
