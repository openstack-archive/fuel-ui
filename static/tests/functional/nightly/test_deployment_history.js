...
registerSuite(() => {
  ...
  return {
    ...
    history_after_first_deployment() {
    ...
    history_after_third_deployment() {
    ...
    history_timeline_equls_table_view() {
