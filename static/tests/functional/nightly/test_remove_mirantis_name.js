  ...
  return {
    ...
    'Check that "Mirantis" names and reference are removed from generic pages'() {
      ...
      return this.remote
        ...
        .assertElementNotMatchesRegExp('support-box-content h3', mirantisRegExp,
          '"Fuel Documentation" pane not contains Mirantis names')
        .assertElementNotMatchesRegExp('support-box-content h3 p', mirantisRegExp,
          '"Fuel Documentation" pane not contains Mirantis names')
        .assertElementNotMatchesRegExp('.statistics-text-box div', RegExp('Mirantis OpenStack', 'i'),
