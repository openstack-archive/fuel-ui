  ...
  return {
    ...
    'Check that "Mirantis" names and reference are removed from generic pages'() {
      ...
      return this.remote
        ...
        .assertElementNotMatchRegExp('support-box-content h3', mirantisRegExp,
          '"Fuel Documentation" pane not contains Mirantis names')
        .assertElementNotMatchRegExp('support-box-content h3 p', mirantisRegExp,
          '"Fuel Documentation" pane not contains Mirantis names')
        .assertElementNotMatchRegExp('.statistics-text-box div', RegExp('Mirantis OpenStack', 'i'),
          '"Send Statistics About Usage" block not contains Mirantis names')
        .assertElementNotMatchRegExp('.checkbox-group label', mirantisRegExp,
