    ...
    return {
      ...
      'Test additional, -ml2:tun, -vmware, !Sahara, +block:ceph': function() {
        var smile = 'input[value=additional_service\\:smile]',
            vmware = 'input[value=hypervisor\\:vmware]',
            vlan = 'input[value=network\\:neutron\\:ml2\\:vlan]',
            tun = 'input[value=network\\:neutron\\:ml2\\:tun]',
            sahara = 'input[value=additional_service\\:sahara]'
