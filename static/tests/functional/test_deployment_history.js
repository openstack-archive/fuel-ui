  ...
  return {
    ...
    'Test deployment history tab of finished deployment'() {
      ...
      return this.remote
        ...
        .assertElementsExist(
          '.filters .filter-by-task_name, .filters .filter-by-type,' +
          '.filters .filter-by-node_id, .filters .filter-by-status',
          4,
          'Three filters are presented: filter by Task Name, Task Type, Node, and by Task Status'
        )
