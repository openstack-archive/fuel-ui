  ...
  registerSuite(function() {
    ...
    return {
      ...
      'Test several plugins with different attributes for BOND': function() {
        ...
        var attrPlugin1 = '.ifc-list > div:nth-child(1) span.fuel_plugin_example_v5 button';
        var attrPlugin2 = '.ifc-list > div:nth-child(1) span.fuel-plugin-vmware-dvs button';
        var itfConfigure = 'button.btn-configure-interfaces';
        ...
        return this.remote
          ...
          .bondInterfaces(-1, -2)
          .assertElementExists('input[label="bond0"]', 'Bonds was not created')
          .assertElementExists(attrPlugin1, 'Bond attributes for plugin-1 are not presented')
          .assertElementExists(attrPlugin2, 'Bond attributes for plugin-2 are not presented')

          .clickByCssSelector(attrPlugin1)
          ...
          .clickByCssSelector(attrPlugin2)
