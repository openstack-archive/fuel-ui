...
ClusterPage.prototype = {
  ...
  resetEnvironment: function(clusterName) {
    ...
    return this.remote
      ...
      .then(() => self.modal.waitToOpen())
      .then(() => self.modal.checkTitle('Reset Environment'))
      .then(() => self.modal.clickFooterButton('Reset'))
  ...
  deployEnvironment: function() {
    var self = this;
    return this.remote
      .then(() => self.goToTab('Dashboard'))
      .then(() => self.dashboardPage.startDeployment())
