  ...
  return {
    ...
    '"Show" button availability and logs displaying'() {
      ...
      return this.remote
        ...
        // Something wrong with this fakeServer execution, locally it doesn't affect anything
        // .execute(() => {
        ...
        // Next line is commented because of unknown issue: this test passed locally
