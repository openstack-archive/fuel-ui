  ...
  return {
    ...
    'Provision nodes'() {
      ...
      return this.remote
        ...
        .assertElementDisappears('div.deploy-process div.progress', 100000, 'Provisioning finished')
        .assertElementContainsText(
    ...
    'Deploy nodes'() {
      ...
      return this.remote
        ...
        .assertElementDisappears('div.deploy-process div.progress', 100000, 'Deployment finished')
        .assertElementContainsText(
          'div.alert-success strong',
          'Success',
