...
define([
  ...
  registerSuite(function() {
    ...
    return {
      ...
      'Test create plugin with xen': function() {
      // https://mirantis.testrail.com/index.php?/cases/view/842470
        ...
        return this.remote
          ...
          .assertElementDisabled('input[name=hypervisor\\:xen]',
                                 'Xen checkbox is enabled with vCenter')

          // Disable vCenter, enable xen and check that vCenter is disabled
          .clickByCssSelector('input[name=hypervisor\\:vmware]')
          .clickByCssSelector('input[name=hypervisor\\:xen]')
          .assertElementDisabled('input[name=hypervisor\\:vmware]',
                                 'vCenter checkbox is enabled with xen')
