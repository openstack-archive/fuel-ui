...
define([
  ...
  registerSuite(function() {
    ...
    return {
      ...
      'Test create plugin with object:cat, incompatible with block:lvm': function() {
      // https://mirantis.testrail.com/index.php?/cases/view/842459
        ...
        return this.remote
          ...
          // Check that Stor ceph is disabled when LVM is enabled (by default)
          .assertElementDisabled('input[value=storage\\:object\\:cat]',
                                 'Stor ceph is enabled with LVM')
