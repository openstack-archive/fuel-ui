    ...
    return {
      ...
      // https://mirantis.testrail.com/index.php?/cases/view/842469 (steps 1-2, 4-5)
        ...
        return this.remote
          ...
          .assertElementExists('i.tooltip-icon.glyphicon-info-sign[data-reactid*="nsx"][data-original-title='+
                               '"This component was not tested with the following components: QEMU-KVM"]')
