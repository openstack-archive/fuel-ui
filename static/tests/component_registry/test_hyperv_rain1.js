...
define([
  ...
  registerSuite(function() {
    ...
    return {
      ...
      'Test that all hypervisor types are displayed as checkboxes in wizzard': function() {
      // https://mirantis.testrail.com/index.php?/cases/view/842468
        ...
        return this.remote
          ...
          .assertElementExists('input[name=hypervisor\\:xen][type="checkbox"]',
                               'Xen were not displayed as a checkbox')
          .assertElementExists('input[name=hypervisor\\:libvirt\\:rain1][type="checkbox"]',
                               'Rain were not displayed as a checkbox')
