...
var NotificationsPopover = React.createClass({
  ...
  renderNotification(notification) {
    ...
    // show not more than 10 lines of notification text
    const MAX_NOTIFICATION_LENGTH = 10 * 30;
    var message = _.truncate(notification.get('message'), {length: MAX_NOTIFICATION_LENGTH});
