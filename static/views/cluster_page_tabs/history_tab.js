  ...
  statics: {
    ...
    checkSubroute(tabProps) {
      ...
      if (activeTab === 'history') {
        ...
        return {activeTransactionId: subroute || null};
      }
                          ...
                          (transactionId) => {
                            return (
                              <li key={transactionId}>
                                <a href={'#cluster/' + cluster.id + '/history/' + transactionId}>
                  ...
                  return (
                    <div key={transactionId}>
                      <a
                        ...
                        href={'#cluster/' + cluster.id + '/history/' + transactionId}
                      >
                        <span>{'#' + transactionId}</span>
                      </a>
...
DeploymentHistoryScreen = React.createClass({
  statics: {
    fetchData(transactionId) {
      ...
      history.url = '/api/transactions/' + transactionId + '/deployment_history';
