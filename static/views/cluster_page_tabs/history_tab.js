...
HistoryTab = React.createClass({
  ...
  loadScreenData(transactionId) {
    ...
    if (_.isNull(transactionId)) return null;
  ...
  render() {
    ...
    var activeTransactionGraphType = activeTransaction.get('graph_type');
          ...
          {transactions.length ?
            <div>
                          ...
                          (transaction) => {
                            return (
                              <li key={transaction.id}>
                                <a
                                  href={'#cluster/' + cluster.id + '/history/' + transaction.id}
              ...
              {activeTransaction &&
                <div
                  className={
                    utils.classNames('transaction-summary', activeTransaction.get('status'))
                  }
                >
                  <div className='row'>
