...
var NetworkTab = React.createClass({
  ...
  statics: {
    ...
    checkSubroute(props) {
      var {activeTab, showAllNetworks} = props;
      var {section, groupId, id} = props.params;
      ...
      .then(() => {
        return nodeNetworkGroup
          ...
          .then(() => {
            ...
            app.navigate('/cluster/' + this.props.cluster.id + '/network/' + defaultSubtab);
          });
      });
  },
