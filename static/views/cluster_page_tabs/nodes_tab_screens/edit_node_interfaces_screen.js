...
var NodeInterface = React.createClass({
  ...
  render() {
    ...
    var connectionStatusClasses = (ifc) => {
      var ifcState = ifc.get('state');
      // Newly created bonds should be in down state until saved and data reloaded from the backend
      var isInterfaceDown = ifcState === 'down' || _.isUndefined(ifcState);
      return {
