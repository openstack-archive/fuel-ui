    ...
    return connectDropTarget(
      <div className='unassigned-networks col-xs-12'>
        <div className='ifc-container'>
          <div className={
            utils.classNames({'ifc-inner-container clearfix': true, compact: isCompact, collapsed})
          }>
            <div className='ifc-header row'>
              <div className='common-ifc-name no-checkbox col-xs-10'>
                {i18n(ns + 'unassigned_networks', {count: networks.length})}
              </div>
              <div className='col-xs-2 toggle-configuration-control'>
                <i
                  className={utils.classNames({
