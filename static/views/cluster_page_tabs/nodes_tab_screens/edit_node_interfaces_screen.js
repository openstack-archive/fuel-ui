              ...
              return (
                <Tooltip key={mode + '-view'} text={i18n(ns + mode + '_mode_tooltip')}>
                  <label
                    ...
                    onClick={
                      mode !== viewMode && _.partial(this.changeViewMode, 'view_mode', mode)
                    }
                  >
              ...
              <div className='col-xs-3'>
                <div className='pull-left'>
                  ...
                  {_.map(isCompact ? [ifc] : slaveInterfaces, (slaveInterface, index) => {
                    ...
                    var showWarningIcon = isCompact && isBond && interfaceStatusClasses['ifc-offline'];
                    return (
                      <div
                          ...
                          {isCompact ?
                            ...
                            [
                              this.props.nodes.length === 1 &&
                                <div key='mac'>{i18n(ns + 'mac')}: {slaveInterface.get('mac')}</div>,
                              <div key='speed'>
