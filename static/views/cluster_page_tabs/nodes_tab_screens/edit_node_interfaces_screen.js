        ...
        {_.map(renderableSections, (sectionName) => {
          ...
          var settings = _.map(_.omit(section, 'metadata'),
            (setting, settingName) => {
              ...
              if (limitations[sectionName] && !limitations[sectionName][result.settingName].equal) {
                isRestricted = true;
              }
              return result;
            });
          ...
          var {settingName: defaultName, value: defaultValue} = defaultField;
          if (sectionName === 'offloading') {
            defaultValue = this.makeOffloadingModesExcerpt();
          } else if (defaultName === 'disabled' || defaultName === 'disable') {
            defaultValue = defaultValue ?
                i18n(ns + 'disabled_value') : i18n(ns + 'enabled_value');
            ...
            defaultValue = defaultValue ?
                i18n(ns + 'enabled_value') : i18n(ns + 'disabled_value');
