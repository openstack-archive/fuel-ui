        ...
        >
          ...
          {!isCompact ?
            <NodeInterfaceAttributes
              {... _.pick(this.props, 'interface', 'limitations',
                'locked', 'validate', 'nodes')
              }
              interfacePropertyErrors={(this.props.errors || {}).interface_properties || {}}
            /> :
...
var NodeInterfaceAttributes = React.createClass({
  ...
  getInterfacePropertyError() {
    return this.props.interfacePropertyErrors[this.state.activeInterfaceSectionName] || null;
  },
  ...
  renderConfigurableAttributes() {
    ...
    var errors = this.props.interfacePropertyErrors;
