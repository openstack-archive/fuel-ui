...
var NodeInterfaceAttributes = React.createClass({
  ...
  renderInterfaceSubtab() {
    ...
    if (activeSection === 'offloading') {
      ...
      return <OffloadingModesSubtab interface={ifc} offloadingModes={attributes.offloading} {..._.pick(this.props, 'locked')}/>;
    } else if(activeSection==='dpdk') {
      // offloading uses custom component
      return <DpdkSubtab interface={ifc} {..._.pick(this.props, 'nodesInterfaces')}/>;
    }
