...
var NodeInterfaceAttributes = React.createClass({
  ...
  renderConfigurableSections(renderableSections) {
    var {interface: ifc, limitations, errors} = this.props;
    var attributes = ifc.get('attributes');
  ...
  renderInterfaceSubtab() {
      ...
      return (
        <DPDKSubtab
          ...
          {..._.pick(this.props, 'nodesInterfaces', 'locked',
            'getAvailableBondingTypes', 'interface', 'errors')}
        />
      );
    } else if (activeSection === 'sriov') {
      return (
        <SRIOVSubtab
          {..._.pick(this.props, 'nodesInterfaces', 'locked', 'interface', 'errors')}
        />
      );
    }
    ...
    ifc.get('attributes').validationError = this.props.errors;
    var configModels = {};
