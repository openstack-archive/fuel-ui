...
var EditNodeInterfacesScreen = React.createClass({
  ...
  componentWillMount() {
    this.setState({
      ...
      availableBondingTypes: this.props.nodes.at(0)
        .interfaces.reduce((result, ifc, index) => {
          result[ifc.get('name')] = _.intersection(... _.compact(
  ...
  render() {
    ...
    var {availableBondingTypes} = this.state;
