...
NodeListScreen = React.createClass({
  ...
  getInitialState() {
    ...
    var uiSettings = this.props.saveUISettings && (cluster || fuelSettings).get('ui_settings');
    ...
    var search = uiSettings ? uiSettings.search : '';
