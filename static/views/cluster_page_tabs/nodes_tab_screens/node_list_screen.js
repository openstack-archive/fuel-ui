...
var NodeListScreenWrapper, NodeListScreen, MultiSelectControl, NumberRangeControl, ManagementPanel,
...
NodeListScreenWrapper = React.createClass({
  propTypes: {
  ...
  getInitialState() {
    ...
    var states = {activeFilters, activeSorters, search, viewMode};
  ...
  render() {
    var {cluster, nodes, availableSorters, availableFilters, showRolePanel} = this.props;
    ...
    return (
      <NodeListScreen
        ...
        availableSorters={_.map(availableSorters, (name) => new Sorter(name, 'asc', false))}
        availableFilters={_.map(availableFilters, (name) => {
...
export default NodeListScreenWrapper;
