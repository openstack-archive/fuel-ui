...
var DashboardTab = React.createClass({
  ...
  render() {
    ...
    var runningDeploymentTask = cluster.task({active: true});
    var finishedDeploymentTask = cluster.task({active: false});
    var dashboardLinks = [{
      url: '/',
