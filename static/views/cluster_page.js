...
var ClusterPage = React.createClass({
  ...
  statics: {
    breadcrumbsPath(pageOptions) {
      ...
      console.warn('Cluster breadcrumbs options:', app.breadcrumbs);
      var breadcrumbs = [
        ['home', '/'],
        ['environments', '/clusters'],
        [clusterTitle ? clusterTitle : 'Cluster Name Here', '/cluster/' + clusterId, {skipTranslation: true}]
      ];
    ...
    title() {
      var clusterTitle = app.breadcrumbs['clusterName'];
      return clusterTitle ? clusterTitle : 'Cluster Name Here';
    },
    getTabs() {
      return [
    ...
    loadProps(props, cb) {
      ...
      var tabOptions = [];
      var activeTab = null;
      console.log('Fetch cluster. props: ', props, app);
      id = Number(id);
      ...
      try {
        ...
        console.warn('No cluster in app.page.props');
      }
      ...
      if (currentClusterId === id) {
        ...
        promise = $.when(
          ...
          .then(() => {
            ...
            console.log('* Breadcrumbs:', app.breadcrumbs);
  ...
  getInitialState() {
    ...
    console.log('Initial state: ', activeTab, this.props);
    var states = {
  ...
  componentWillReceiveProps(newProps) {
    ...
    if (tab.checkSubroute) {
      console.log('CheckSubRoute', activeTab);
  ...
  render() {
    ...
    console.log('Screen props:', props, Tab);
